...
class CrossPointSettings : public PersistableStore<CrossPointSettings> {
 ...
 public:
  ...
  // Default folder for a feed's combined EPUB ("/RSS"), used by every feed
  // whose own RssFeed::folder is empty. Edited from the RSS feed list.
  // Persisted via a category-less SettingInfo::String in SettingsList.h, so
  // it stays out of the on-device Settings screen.
  char rssDownloadFolder[64] = "/RSS";
  // Hide battery percentage
